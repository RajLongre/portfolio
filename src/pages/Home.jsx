    ...
    <Layout>
      <div>
        <div className="h-screen bg-theme">
          <div className="grid grid-cols-2 h-screen items-center border-4 mx-10 z-10 bg-theme border-white transform rotate-0 md:grid-cols-1 md:border-2 md:rotate-0">
            <div className="h-1/2">
              <lottie-player
            ...
            <div className="font-bold text-white md:px-5">
              <h1 className="text-5xl md:text-4xl" data-aos="slide-right">
                Hii , I am <b className="text-yellow-500">RAJ LONGRE</b>
              </h1>
          ...
          <div className="md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-gray-700 hover:text-white">
            ...
            <div className="grid md:grid-cols-1 grid-cols-3 p-5">
              ...
              <div className="text-right">
                <h1 className="text-xl font-bold ">BackEnd and Database</h1>
                <hr />
          ...
          <div className="h-screen relative text-gray-800">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <h1 className="text-2xl font-bold">
                Hi, Hello, Namaste...
                <hr />
                <pre className="text-xl md:text-sm font-mont font-semibold">
                  {JSON.stringify(
                    {
                      name: "Raj Longre",
                      age: 21,
